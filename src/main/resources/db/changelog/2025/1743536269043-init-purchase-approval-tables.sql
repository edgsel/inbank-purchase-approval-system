...
CREATE TYPE CUSTOMER_STATUS AS ENUM ('ELIGIBLE', 'INELIGIBLE');
CREATE TYPE PURCHASE_STATUS AS ENUM ('APPROVED', 'APPROVED_WITH_AMOUNT_RANGE', 'APPROVED_WITH_EXTENDED_PAYMENT_PERIOD', 'REJECTED');
